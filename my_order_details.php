                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
											...
											$res=mysqli_query($con,"select distinct(order_detail.id),order_detail.*,product.name,product.image, company.com_name,division.id,division.name as dv_name,district.id,district.name as ds_name from order_detail,product,`order`,company,division,district where order_detail.order_id='$order_id' and `order`.user_id='$uid' and order_detail.product_id=product.id and order_detail.company_id=company.id and order_detail.division_id =division.id and order_detail.district_id=district.id");
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-name"> <img src="employee/<?php echo $row['image']?>"></td>
                                                <td class="product-name"><?php echo $row['com_name']?></td>

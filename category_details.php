...
if(isset($_GET['catsort'])){
    $sort=mysqli_real_escape_string($con,$_GET['catsort']);
    if($sort=="price_high"){
...
//category name show
$cat=mysqli_fetch_assoc(mysqli_query($con,"select cat_name from category where id='$cat_id'"));
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active"><?php echo $cat['cat_name']?></span>
                                </nav>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                <div class="htc__select__option">
                                    <select class="ht__select" onchange="sort_catproduct_drop('<?php echo $cat_id?>','<?php echo SITE_PATH?>')" id="sort_product_id">

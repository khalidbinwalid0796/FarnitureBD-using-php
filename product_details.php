...
if(isset($_GET['id'])){
	...
	if($product_id>0){
        ...
        $com_id=$get_product['0']['company_id'];
	}else{
		?>
		<script>
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="category_details.php?id=<?php echo $get_product['0']['category_id']?>"><?php echo $get_product['0']['cat_name']?></a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                            <img src="employee/<?php echo $get_product['0']['image']?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ht__pro__desc">
                                    ...
                                    <div class="sin__desc align--left">
                                        ...
                                        <ul class="pro__cat__list">
                                            <li><a href="#"><?php echo $get_product['0']['cat_name']?></a></li>
                                        </ul>
                                    </div>
